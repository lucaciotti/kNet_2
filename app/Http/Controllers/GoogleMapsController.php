	...
	*/
    ...
    public function getDirections()
    {
        ...
        $d =   \GoogleMaps::load('directions')
            ...
            ->setParamByKey('origin', 'via dei Martiri, Rimini, Italy')
            ->setParamByKey('destination', 'via Piane, Coriano, Italy')
    ...
    public function getTextSearch()
    {
        ...
        $d =   \GoogleMaps::load('textsearch')
            ->setParam([
                'query'     => 'restaurants near Rimini, Italy',
                'radius'    => '500',
                'types'     => 'restaurant',
            ])
            // ->get();
            ->getResponseByKey('results.name,results.formatted_address');
