<template>
  ...
  >
    <boxDefault>
      ...
      <div
        class="form-group has-feedback"
        :class="{ 'has-error': form.errors.has('typeProd') }"
    ...
    <boxDefault v-show="(isAcquistaKK && isAcquistaKK!=null)">
      ...
      >
        ...
        <input
          type="text"
          class="form-control"
          name="yes_supplierName"
          v-model="form.yes_supplierName"
        >
        <transition name="fade">
          <span
            class="help-block"
      ...
      <div
        class="form-group has-feedback"
        :class="{ 'has-error': form.errors.has('yes_isInformato') }"
      >
    ...
    >
      ...
      <div
        class="form-group has-feedback"
        :class="{ 'has-error': form.errors.has('notWhy') }"
        @change="form.errors.clear($event.target.name)"
      >
      ...
      >
        ...
        <input
          type="text"
          class="form-control"
          name="not_supplierName"
          v-model="form.not_supplierName"
        >
        <transition name="fade">
          <span
            class="help-block"
    ...
    <box-default v-show="isTheEnd">
      <div class="form-group has-feedback" :class="{ 'has-error': form.errors.has('final_note') }">
  ...
  data() {
    return {
      form: new Form({
        ...
        typeProdPorte: JSON.parse(this.modcarp).prod_porte,
        typeProdFinestre: JSON.parse(this.modcarp).prod_portefinestre,
        typeProdCucine: JSON.parse(this.modcarp).prod_cucice,
        ...
        sysBuyOfKK: JSON.parse(this.modcarp).sys_buy_of_k_k,
        sysBuyOfOther: JSON.parse(this.modcarp).sys_buy_of_other,
        sysLiked: JSON.parse(this.modcarp).sys_liked,
        yes_supplierType: JSON.parse(this.modcarp).yes_supplierType.toString(),
        yes_supplierName: JSON.parse(this.modcarp).yes_supplierName,
        yes_isInformato: JSON.parse(this.modcarp).yes_isInformato
          ? "true"
          : "false",
        not_why_prezzo: JSON.parse(this.modcarp).not_why_prezzo,
        not_why_qualita: JSON.parse(this.modcarp).not_why_qualita,
        not_why_servizio: JSON.parse(this.modcarp).not_why_servizio,
        not_why_catalogo: JSON.parse(this.modcarp).not_why_catalogo,
        not_why_noinfo: JSON.parse(this.modcarp).not_why_noinfo,
        not_supplierType: JSON.parse(this.modcarp).not_supplierType.toString(),
        not_supplierName: JSON.parse(this.modcarp).not_supplierName,
        wants_tryKK: JSON.parse(this.modcarp).wants_tryKK ? "true" : "false",
        notryKK_note: JSON.parse(this.modcarp).notryKK_note,
        wants_info: JSON.parse(this.modcarp).wants_info ? "true" : "false",
        final_note: JSON.parse(this.modcarp).final_note,
        vote: JSON.parse(this.modcarp).vote
      }),
      isConosceKK: JSON.parse(this.modcarp).know_kk,
      oldConosceKK: JSON.parse(this.modcarp).know_kk ? "true" : "false",
      isAcquistaKK: JSON.parse(this.modcarp).isKkBuyer,
      oldAcquistaKK: JSON.parse(this.modcarp).isKkBuyer ? "true" : "false",
      isTryKK: JSON.parse(this.modcarp).wants_tryKK,
      oldTryKK: JSON.parse(this.modcarp).wants_tryKK ? "true" : "false",
      isTheEnd: true,
      optionsSysMkt: JSON.parse(this.sysmkt),
      preSysKnown: JSON.parse(this.modcarp).sys_known
    };
  },
