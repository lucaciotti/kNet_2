<template>
  <form method="POST" @submit.prevent="onSubmit" @keydown="form.errors.clear($event.target.name)" @change='checkGoOn'>
    ...
    <boxDefault v-show="(isAcquistaKK && isAcquistaKK!=null)">
      ...
      <div class="form-group has-feedback" :class="{ 'has-error': form.errors.has('wants_info') }" v-show="!form.yes_isInformato && form.yes_isInformato!=null">
    ...
    <button type="submit" class="btn btn-success btn-block" :disabled="form.errors.any()" v-show="isTheEnd">
