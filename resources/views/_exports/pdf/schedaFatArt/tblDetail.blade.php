<table class="table table-hover table-striped" id="statFattArtCli" style="text-align: center;">
    ...
    <thead>
        ...
        <tr>
            <th style="text-align: center;">Macro Gruppo</th>
    ...
    <tbody>
        ...
        @if($newMacroGrp!=$macroGrp)
            <tr>
                <th colspan="{!! 9+(3*($yearBack)) !!}" bgcolor="#FED8B1" style="text-align: left;">
        ...
        @if($newGruppo!=$gruppo)
            <tr>
                <th>&nbsp;</th>
                <th colspan="{!! 8+(3*($yearBack)) !!}" bgcolor="#90EE90" style="text-align: left;">
