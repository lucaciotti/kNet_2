        ...
        <div class="tab-pane active" id="portfolioStats">
            <table class="table table-hover table-striped" id="portfolioTbl" style="text-align: center;">
                <thead>
                    <tr>
                        <th colspan="1">&nbsp;</th>
                        <th colspan="4" style="text-align: center;">{{ \Carbon\Carbon::createFromDate(null, $mese, null)->format('F')}} {{ $thisYear }}</th>
                        <th colspan="1">&nbsp;</th>
                        <th colspan="1" style="text-align: center;">{{ \Carbon\Carbon::createFromDate(null, $mese, null)->format('F')}} {{ $prevYear }}</th>
                    </tr>
                    <tr>
                        <th colspan="1">&nbsp;</th>
