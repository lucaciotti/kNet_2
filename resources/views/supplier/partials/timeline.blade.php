<ul class="timeline">
  ...
  <li>
    ...
    <span class="timeline-item">
      <a class="btn btn-sm btn-default" href="{{ route('visit::insert', $codcli) }}"> <i class="fa fa-plus"></i> <span>{{ trans('supplier.insEvent') }}</span></a>
      <a class="btn btn-sm btn-primary" href="{{ route('visit::show', $codcli) }}">  <span>{{ trans('supplier.seeTimeline') }}... </span></a>
    </span>
  </li>
</ul>
