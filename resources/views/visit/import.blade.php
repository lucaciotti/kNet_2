            ...
            <div class="col-lg-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title" data-widget="collapse">Import Visite</h3>
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{ route('visit::importXls') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
