<ul class="timeline">
      ...
      @endswitch
        <div class="timeline-item">
          ...
          <div class="timeline-footer text-right">
            <a href='{{ route('visit::editSupplier', ['id'=>$visit->id]) }}' class="btn btn-primary btn-sm">Edit</a>
            <form action="{{ route('visit::deleteSupplier', ['id'=>$visit->id]) }}" method="post" style="display: inline;" id="delete_visit_form" onsubmit="return deleteVisit()">
  ...
  <li>
    ...
    <span class="timeline-item">
      @if($codcli)
        <a class="btn btn-sm btn-default" href="{{ route('visit::insertSupplier', $codcli) }}"> <i class="fa fa-plus"></i> <span>{{ trans('visit.insEventSupplier') }}</span></a>
      @else
