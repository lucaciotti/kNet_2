          ...
          <form action="{{ route('visit::store') }}" method="POST" onsubmit="return checkForm()">
            ...
            <div class="form-group">
              ...
              <div id="lastType" class="radio" style="display: none;">
                <label>
                  <input type="radio" name="optLastType" id="optLastType1" value="0" @if ($optLastType==0) checked @endif> {{ trans('visit.eventComeBack') }}
                </label>
                <label>
                  <input type="radio" name="optLastType" id="optLastType2" value="1" @if ($optLastType==1) checked @endif> {{ trans('visit.eventHotel') }}
                </label>
              </div>
            </div>
            @push('script-footer')
