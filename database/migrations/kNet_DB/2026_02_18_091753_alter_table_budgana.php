...
class AlterTableBudgana extends Migration
{
    ...
    public function up()
    {
        Schema::table('u_budgana', function (Blueprint $table) {
            $table->double('u_budg1')->nullable()->default(0.0)->change();
            $table->double('u_budg2')->nullable()->default(0.0)->change();
            $table->double('u_budg3')->nullable()->default(0.0)->change();
            $table->double('u_kobudg1')->nullable()->default(0.0)->change();
            $table->double('u_kobudg2')->nullable()->default(0.0)->change();
            $table->double('u_kobudg3')->nullable()->default(0.0)->change();
        });
    }
